...
const reviewAnimals = [
  ...
  { id: 'allosaurus', name: '异特龙', narrationReady: true },
  { id: 'brachiosaurus', name: '腕龙', narrationReady: true },
  { id: 'quetzalcoatlus', name: '风神翼龙', narrationReady: true },
  { id: 'elasmosaurus', name: '薄板龙', narrationReady: true },
  { id: 'woolly-rhinoceros', name: '披毛犀', narrationReady: true },
  { id: 'anomalocaris', name: '奇虾', narrationReady: true },
  { id: 'albertosaurus', name: '阿尔伯塔龙', narrationReady: true },
  { id: 'carnotaurus', name: '食肉牛龙', narrationReady: true },
  { id: 'ceratosaurus', name: '角鼻龙', narrationReady: true },
  { id: 'coelophysis', name: '腔骨龙', narrationReady: true },
  { id: 'compsognathus', name: '美颌龙', narrationReady: true },
  { id: 'deinonychus', name: '恐爪龙', narrationReady: true },
  { id: 'baryonyx', name: '重爪龙', narrationReady: true },
  { id: 'giganotosaurus', name: '南方巨兽龙', narrationReady: true },
  { id: 'suchomimus', name: '似鳄龙', narrationReady: true },
  { id: 'oviraptor', name: '窃蛋龙', narrationReady: true },
  { id: 'therizinosaurus', name: '镰刀龙', narrationReady: true },
  { id: 'archaeopteryx', name: '始祖鸟', narrationReady: true },
  { id: 'sinosauropteryx', name: '中华龙鸟', narrationReady: true },
  { id: 'monolophosaurus', name: '单脊龙', narrationReady: true },
  { id: 'herrerasaurus', name: '埃雷拉龙', narrationReady: true },
  { id: 'utahraptor', name: '犹他盗龙', narrationReady: true },
  { id: 'acrocanthosaurus', name: '高棘龙', narrationReady: true },
  { id: 'carcharodontosaurus', name: '鲨齿龙', narrationReady: true },
  { id: 'microraptor', name: '小盗龙', narrationReady: true },
  { id: 'diplodocus', name: '梁龙', narrationReady: true },
  { id: 'argentinosaurus', name: '阿根廷龙', narrationReady: true },
  { id: 'brontosaurus', name: '雷龙', narrationReady: true },
  { id: 'camarasaurus', name: '圆顶龙', narrationReady: true },
  { id: 'plateosaurus', name: '板龙', narrationReady: true },
  { id: 'ankylosaurus', name: '甲龙', narrationReady: true },
  { id: 'euoplocephalus', name: '包头龙', narrationReady: true },
  { id: 'kentrosaurus', name: '肯氏龙', narrationReady: true },
  { id: 'protoceratops', name: '原角龙', narrationReady: true },
  { id: 'styracosaurus', name: '戟龙', narrationReady: true },
  { id: 'pachyrhinosaurus', name: '厚鼻龙', narrationReady: true },
  { id: 'diabloceratops', name: '恶魔角龙', narrationReady: true },
  { id: 'iguanodon', name: '禽龙', narrationReady: true },
  { id: 'edmontosaurus', name: '埃德蒙顿龙', narrationReady: true },
  { id: 'corythosaurus', name: '冠龙', narrationReady: true },
  { id: 'lambeosaurus', name: '赖氏龙', narrationReady: true },
  { id: 'gallimimus', name: '似鸡龙', narrationReady: true },
  { id: 'psittacosaurus', name: '鹦鹉嘴龙', narrationReady: true },
  { id: 'heterodontosaurus', name: '异齿龙', narrationReady: true },
  { id: 'dryosaurus', name: '橡树龙', narrationReady: true },
  { id: 'nigersaurus', name: '尼日尔龙', narrationReady: true },
  { id: 'dimorphodon', name: '双型齿翼龙', narrationReady: true },
  { id: 'anhanguera', name: '古魔翼龙', narrationReady: true },
  { id: 'tapejara', name: '古神翼龙', narrationReady: true },
  { id: 'nyctosaurus', name: '夜翼龙', narrationReady: true },
  { id: 'dsungaripterus', name: '准噶尔翼龙', narrationReady: true },
  { id: 'kronosaurus', name: '克柔龙', narrationReady: true },
  { id: 'liopleurodon', name: '滑齿龙', narrationReady: true },
  { id: 'tylosaurus', name: '海王龙', narrationReady: true },
  { id: 'ophthalmosaurus', name: '大眼鱼龙', narrationReady: true },
  { id: 'shonisaurus', name: '秀尼鱼龙', narrationReady: true },
  { id: 'nothosaurus', name: '幻龙', narrationReady: true },
  { id: 'placodus', name: '楯齿龙', narrationReady: true },
  { id: 'dimetrodon', name: '异齿龙', narrationReady: true },
  { id: 'lystrosaurus', name: '水龙兽', narrationReady: true },
  { id: 'gorgonops', name: '丽齿兽', narrationReady: true },
  { id: 'inostrancevia', name: '伊诺史川兽', narrationReady: true },
  { id: 'postosuchus', name: '波斯特鳄', narrationReady: true },
  { id: 'desmatosuchus', name: '链鳄', narrationReady: true },
  { id: 'megaloceros', name: '大角鹿', narrationReady: true },
  { id: 'glyptodon', name: '雕齿兽', narrationReady: true },
  { id: 'megatherium', name: '大地懒', narrationReady: true },
  { id: 'doedicurus', name: '星尾兽', narrationReady: true },
  { id: 'paraceratherium', name: '巨犀', narrationReady: true },
  { id: 'gomphotherium', name: '铲齿象', narrationReady: true },
  { id: 'macrauchenia', name: '后弓兽', narrationReady: true },
  { id: 'thylacoleo', name: '袋狮', narrationReady: true },
  { id: 'opabinia', name: '欧巴宾海蝎', narrationReady: true },
  { id: 'hallucigenia', name: '怪诞虫', narrationReady: true },
  { id: 'titanoboa', name: '泰坦巨蟒', narrationReady: true },
] as const
