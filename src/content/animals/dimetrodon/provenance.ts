...
export const provenance = [
  {
    ...
    source: {
      type: 'generated',
      title: 'Dimetrodon deterministic procedural model source',
      ...
      sha256: '734df23dd76ab8baeae2e77ae8848b920a752c22ec629ef229d66231b258a0d3',
      bytes: 97604,
    },
    license: {
      spdx: 'CC0-1.0',
    ...
    runtime: {
      sha256: '6a596a6fd73702ef9ea800318ac6e26fe57c458395d83d32da4800e864b20541',
      bytes: 152204,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'generated',
      title: 'Dimetrodon habitat scene — landscape',
      tool: 'Blender 4.5.12 (project-authored habitat scene, deterministic seed)',
      generatedOn: '2026-08-17',
      prompt: 'Deterministic project-authored Blender habitat scene; scene spec qa/derivatives-scene-spec.json (SHA-256 125a0017f6b92aebe4c9419e94c9e401f413427fcd0e7efdbcd756ed167cd24f) rendered with seed 3602187128 for the land habitat.',
      sha256: '125a0017f6b92aebe4c9419e94c9e401f413427fcd0e7efdbcd756ed167cd24f',
      bytes: 13351,
    },
    license: {
    ...
    runtime: {
      sha256: '7b41426c14a5389a116bd7ec5c67ddef05343079d59bebde71b58f43af91149b',
      bytes: 15838,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'generated',
      title: 'Dimetrodon habitat scene — portrait',
      tool: 'Blender 4.5.12 (project-authored habitat scene, deterministic seed)',
      generatedOn: '2026-08-17',
      prompt: 'Deterministic project-authored Blender habitat scene; scene spec qa/derivatives-scene-spec.json (SHA-256 125a0017f6b92aebe4c9419e94c9e401f413427fcd0e7efdbcd756ed167cd24f) rendered with seed 3602187128 for the land habitat.',
      sha256: '125a0017f6b92aebe4c9419e94c9e401f413427fcd0e7efdbcd756ed167cd24f',
    ...
    runtime: {
      sha256: '31d749f7cc3a4f6500facb5630c61e7424c08a4bc8f345f001deb1a8c63943de',
      bytes: 9346,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'derived',
      title: 'Dimetrodon transparent model still',
      generatedOn: '2026-08-17',
      inputAssetPaths: [
        'model/model.glb',
      ],
    ...
    runtime: {
      sha256: '62fe1237de7c343e31d0f41368f573d90e6647be4b5c58c94fa7724eb99fe93d',
      bytes: 11708,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'derived',
      title: 'Dimetrodon transparent portrait model still',
      generatedOn: '2026-08-17',
      inputAssetPaths: [
        'model/model.glb',
      ],
    ...
    runtime: {
      sha256: 'c92ed47041c05c6cf4feb64715426f8891a17a2b8059d1ee558f4d8491da657e',
      bytes: 3870,
    },
    modifications: [
      'Removed the habitat composite and all interface chrome; kept only the model and contact shadow on a transparent background.',
  ...
  },
  {
    ...
    source: {
      type: 'derived',
      title: 'Dimetrodon collection thumbnail',
      generatedOn: '2026-08-17',
      inputAssetPaths: [
        'model/model.glb',
    ...
    runtime: {
      sha256: 'c4cacd515f24e63fc88fbea35ea1f97779a69d7e6f1a04a07f52943402e712af',
      bytes: 2744,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'generated',
      title: 'Dimetrodon Mandarin narration',
      ...
      generatedOn: '2026-08-17',
      prompt: '这是异齿龙，学名是Dimetrodon grandis。看看它醒目的“back sail”外形，再观察轻轻的呼吸、转头和尾部动作。',
      sha256: '73edadd5e7fef367c558257efebaa22679ff1619cfcbd1587003d75c4a84e006',
      bytes: 89516,
    },
    license: {
      spdx: 'CC-BY-NC-SA-4.0',
  ...
  },
  {
    ...
    source: {
      type: 'generated',
      title: 'Dimetrodon English narration',
      tool: 'Qwen3-TTS CustomVoice',
      model: 'Qwen/Qwen3-TTS-12Hz-0.6B-CustomVoice',
      revision: '85e237c12c027371202489a0ec509ded67b5e4b5; Serena built-in voice; deterministic local generation',
      generatedOn: '2026-08-17',
      prompt: 'This is Dimetrodon, a prehistoric animal known as Dimetrodon grandis. Look for its back sail. Watch the gentle breathing, head movement and tail motion that make this reconstruction feel alert.',
      sha256: '139d8e57c57e67c0a48ddffb4aebbf4f1cd544ddfa47b9a2ca669ac244773e04',
      bytes: 126572,
    },
    license: {
      spdx: 'CC-BY-NC-SA-4.0',
