...
export const provenance = [
  {
    ...
    source: {
      type: 'generated',
      title: 'Ankylosaurus deterministic procedural model source',
      ...
      sha256: 'fa8542adcc50669b51fc1e6b6a415de5fbf3a7e90b83ac5cc347c0f38b73b56a',
      bytes: 118776,
    },
    license: {
      spdx: 'CC0-1.0',
    ...
    runtime: {
      sha256: '604b4e092efd5f77652cd3ca941ee570b22f6181e0b7b0c332c677cfb0d475c4',
      bytes: 2002112,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'generated',
      title: 'Ankylosaurus habitat scene — landscape',
      tool: 'Blender 4.5.12 (project-authored habitat scene, deterministic seed)',
      generatedOn: '2026-08-17',
      prompt: 'Deterministic project-authored Blender habitat scene; scene spec qa/derivatives-scene-spec.json (SHA-256 3618327b087af6574441994f90b5ab98f7ba40c627a2fc6295d31479a83812b7) rendered with seed 3807037400 for the land habitat.',
      sha256: '3618327b087af6574441994f90b5ab98f7ba40c627a2fc6295d31479a83812b7',
      bytes: 13356,
    },
    license: {
    ...
    runtime: {
      sha256: '5972bca8c1f14a8d84b2922b86a22d0b25d9757bb89f967ce676942dab0341d4',
      bytes: 15002,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'generated',
      title: 'Ankylosaurus habitat scene — portrait',
      tool: 'Blender 4.5.12 (project-authored habitat scene, deterministic seed)',
      generatedOn: '2026-08-17',
      prompt: 'Deterministic project-authored Blender habitat scene; scene spec qa/derivatives-scene-spec.json (SHA-256 3618327b087af6574441994f90b5ab98f7ba40c627a2fc6295d31479a83812b7) rendered with seed 3807037400 for the land habitat.',
      sha256: '3618327b087af6574441994f90b5ab98f7ba40c627a2fc6295d31479a83812b7',
    ...
    runtime: {
      sha256: '7c89ef44929bcaad740be3492e5d5352e93493289a9dc3bb8bd6155e84caac53',
      bytes: 8212,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'derived',
      title: 'Ankylosaurus transparent model still',
      generatedOn: '2026-08-17',
      inputAssetPaths: [
        'model/model.glb',
      ],
    ...
    runtime: {
      sha256: '23a1782eff6fb43b220d79e78c7f0c6d6039ebcaa7fbd57e957ae2704c98ebba',
      bytes: 11212,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'derived',
      title: 'Ankylosaurus transparent portrait model still',
      generatedOn: '2026-08-17',
      inputAssetPaths: [
        'model/model.glb',
      ],
    ...
    runtime: {
      sha256: '2177ce33623d23343f1f232716774e1b944b0ac1222d777ab682c581eb20ccec',
      bytes: 3454,
    },
    modifications: [
      'Removed the habitat composite and all interface chrome; kept only the model and contact shadow on a transparent background.',
  ...
  },
  {
    ...
    source: {
      type: 'derived',
      title: 'Ankylosaurus collection thumbnail',
      generatedOn: '2026-08-17',
      inputAssetPaths: [
        'model/model.glb',
    ...
    runtime: {
      sha256: 'b13a48ef62c9d0245e9f53c08129e274584afda4215bbe180ccbf5fd260ac901',
      bytes: 2522,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'generated',
      title: 'Ankylosaurus Mandarin narration',
      ...
      generatedOn: '2026-08-17',
      prompt: '这是甲龙，学名是Ankylosaurus magniventris。看看它醒目的“tail club”外形，再观察轻轻的呼吸、转头和尾部动作。',
      sha256: 'ee743158711ada04826e798f3e0420b446674b2e1bef292df1dc8faec6fc26ed',
      bytes: 99692,
    },
    license: {
      spdx: 'CC-BY-NC-SA-4.0',
  ...
  },
  {
    ...
    source: {
      type: 'generated',
      title: 'Ankylosaurus English narration',
      tool: 'Qwen3-TTS CustomVoice',
      model: 'Qwen/Qwen3-TTS-12Hz-0.6B-CustomVoice',
      revision: '85e237c12c027371202489a0ec509ded67b5e4b5; Serena built-in voice; deterministic local generation',
      generatedOn: '2026-08-17',
      prompt: 'This is Ankylosaurus, a prehistoric animal known as Ankylosaurus magniventris. Look for its tail club. Watch the gentle breathing, head movement and tail motion that make this reconstruction feel alert.',
      sha256: '4c59456717d383378683ba5824f7f8d08bd76dcc90090112203a5127d86d4afd',
      bytes: 152108,
    },
    license: {
      spdx: 'CC-BY-NC-SA-4.0',
