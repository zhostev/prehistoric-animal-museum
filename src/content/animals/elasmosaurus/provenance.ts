...
export const provenance = [
  {
    ...
    source: {
      type: 'generated',
      title: 'Elasmosaurus deterministic procedural model source',
      ...
      sha256: '886cea3d83a953c28ad79846188a9e20e809906f4d78f07d515433758b04054b',
      bytes: 108296,
    },
    license: {
      spdx: 'CC0-1.0',
    ...
    runtime: {
      sha256: '78efe0cced9414c09c7a4fab99ea375ca3eeaffb540e7d77df93993af1742498',
      bytes: 1713480,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'generated',
      title: 'Elasmosaurus habitat scene — landscape',
      tool: 'Blender 4.5.12 (project-authored habitat scene, deterministic seed)',
      generatedOn: '2026-08-17',
      prompt: 'Deterministic project-authored Blender habitat scene; scene spec qa/derivatives-scene-spec.json (SHA-256 a96860e344afd85511cd279a1be8c98eeef7b5eaa0268bdca77bff851dea97a9) rendered with seed 3561462435 for the water habitat.',
      sha256: 'a96860e344afd85511cd279a1be8c98eeef7b5eaa0268bdca77bff851dea97a9',
      bytes: 18997,
    },
    license: {
    ...
    runtime: {
      sha256: 'a446619f7a2416f57f7646fbcfcced5dbefc1fdc6029cc4c9d6117d341c042ed',
      bytes: 107126,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'generated',
      title: 'Elasmosaurus habitat scene — portrait',
      tool: 'Blender 4.5.12 (project-authored habitat scene, deterministic seed)',
      generatedOn: '2026-08-17',
      prompt: 'Deterministic project-authored Blender habitat scene; scene spec qa/derivatives-scene-spec.json (SHA-256 a96860e344afd85511cd279a1be8c98eeef7b5eaa0268bdca77bff851dea97a9) rendered with seed 3561462435 for the water habitat.',
      sha256: 'a96860e344afd85511cd279a1be8c98eeef7b5eaa0268bdca77bff851dea97a9',
    ...
    runtime: {
      sha256: '9fd4147248df68a65b17202df1d8d2c3faaa26462ef79b879007248897480135',
      bytes: 82466,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'derived',
      title: 'Elasmosaurus transparent model still',
      generatedOn: '2026-08-17',
      inputAssetPaths: [
        'model/model.glb',
      ],
    ...
    runtime: {
      sha256: 'f575d53045519889f9dc12f59d3386db2aeedd535c0a9469fcbe2779307184c6',
      bytes: 11042,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'derived',
      title: 'Elasmosaurus transparent portrait model still',
      generatedOn: '2026-08-17',
      inputAssetPaths: [
        'model/model.glb',
      ],
    ...
    runtime: {
      sha256: '472628796f70f59bb833a52b3c6426fc611dbfebebbf3971e47bbc39850cd3d3',
      bytes: 2872,
    },
    modifications: [
      'Removed the habitat composite and all interface chrome; kept only the model and contact shadow on a transparent background.',
  ...
  },
  {
    ...
    source: {
      type: 'derived',
      title: 'Elasmosaurus collection thumbnail',
      generatedOn: '2026-08-17',
      inputAssetPaths: [
        'model/model.glb',
    ...
    runtime: {
      sha256: 'a45413ac554ed231d669d424d56f381b4f7a16401d3004a548ddf9d172aeb617',
      bytes: 2074,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'generated',
      title: 'Elasmosaurus Mandarin narration',
      ...
      generatedOn: '2026-08-17',
      prompt: '这是薄板龙，学名是Elasmosaurus platyurus。看看它醒目的“very long neck”外形，再观察轻轻的呼吸、转头和尾部动作。',
      sha256: '3d7d5b27aee708b4bc761f29100411f875d44e955095ce0369bea303c650459b',
      bytes: 103532,
    },
    license: {
      spdx: 'CC-BY-NC-SA-4.0',
  ...
  },
  {
    ...
    source: {
      type: 'generated',
      title: 'Elasmosaurus English narration',
      tool: 'Qwen3-TTS CustomVoice',
      model: 'Qwen/Qwen3-TTS-12Hz-0.6B-CustomVoice',
      revision: '85e237c12c027371202489a0ec509ded67b5e4b5; Serena built-in voice; deterministic local generation',
      generatedOn: '2026-08-17',
      prompt: 'This is Elasmosaurus, a prehistoric animal known as Elasmosaurus platyurus. Look for its very long neck. Watch the gentle breathing, head movement and tail motion that make this reconstruction feel alert.',
      sha256: '77664561b262a00369703830348b7a4fc8add444162ca4397045a07372f5cbfe',
      bytes: 143852,
    },
    license: {
      spdx: 'CC-BY-NC-SA-4.0',
