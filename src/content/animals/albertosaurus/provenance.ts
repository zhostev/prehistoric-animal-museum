...
export const provenance = [
  {
    ...
    source: {
      type: 'generated',
      title: 'Albertosaurus deterministic procedural model source',
      ...
      sha256: 'c05d5c9867a416b602f5c2ebf9f7cc80f5b2d870673eb3e31cc37193b587d597',
      bytes: 107256,
    },
    license: {
      spdx: 'CC0-1.0',
    ...
    runtime: {
      sha256: 'e9b9bee9aca054c2d49a09df0d3b3cda85f20d63694f2ef4785b952203e28ddb',
      bytes: 164812,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'generated',
      title: 'Albertosaurus habitat scene — landscape',
      tool: 'Blender 4.5.12 (project-authored habitat scene, deterministic seed)',
      generatedOn: '2026-08-17',
      prompt: 'Deterministic project-authored Blender habitat scene; scene spec qa/derivatives-scene-spec.json (SHA-256 3913306b75512e8d73260b2000e314c83a97d3d291b21383078db1887c0077af) rendered with seed 3317668871 for the land habitat.',
      sha256: '3913306b75512e8d73260b2000e314c83a97d3d291b21383078db1887c0077af',
      bytes: 13360,
    },
    license: {
    ...
    runtime: {
      sha256: '699aa7893e3260ef7706d75fa723eb063d7c049741feff4f061e31155684aa3c',
      bytes: 14808,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'generated',
      title: 'Albertosaurus habitat scene — portrait',
      tool: 'Blender 4.5.12 (project-authored habitat scene, deterministic seed)',
      generatedOn: '2026-08-17',
      prompt: 'Deterministic project-authored Blender habitat scene; scene spec qa/derivatives-scene-spec.json (SHA-256 3913306b75512e8d73260b2000e314c83a97d3d291b21383078db1887c0077af) rendered with seed 3317668871 for the land habitat.',
      sha256: '3913306b75512e8d73260b2000e314c83a97d3d291b21383078db1887c0077af',
    ...
    runtime: {
      sha256: '336cf095059e9bf7481879278f9eb6e9f575d66a5b3d40c27e05322586a1f768',
      bytes: 9206,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'derived',
      title: 'Albertosaurus transparent model still',
      generatedOn: '2026-08-17',
      inputAssetPaths: [
        'model/model.glb',
      ],
    ...
    runtime: {
      sha256: '62d28f4f839cc231a8ac55274fb22343b546891be87014e9b20f62be2a467d2b',
      bytes: 10812,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'derived',
      title: 'Albertosaurus transparent portrait model still',
      generatedOn: '2026-08-17',
      inputAssetPaths: [
        'model/model.glb',
      ],
    ...
    runtime: {
      sha256: 'eda2db26ccefabc3588037abf6e6284f1bc818550aeccf78a75833d7a7f08cfb',
      bytes: 3674,
    },
    modifications: [
      'Removed the habitat composite and all interface chrome; kept only the model and contact shadow on a transparent background.',
  ...
  },
  {
    ...
    source: {
      type: 'derived',
      title: 'Albertosaurus collection thumbnail',
      generatedOn: '2026-08-17',
      inputAssetPaths: [
        'model/model.glb',
    ...
    runtime: {
      sha256: 'e40c1280fe6d1c6365ac2a08b246bb1d754d31d30d983c05e30c853eafa200ee',
      bytes: 2482,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'generated',
      title: 'Albertosaurus Mandarin narration',
      ...
      prompt: '这是阿尔伯塔龙，学名是Albertosaurus sarcophagus。看看它醒目的“small brow crests”外形，再观察轻轻的呼吸、转头和尾部动作。',
      sha256: '2c0f4d48774acadb6fd052b9c9945c6adfee0abe365e7d48d6bf4cf483871416',
      bytes: 115628,
    },
    license: {
      spdx: 'CC-BY-NC-SA-4.0',
  ...
  },
  {
    ...
    source: {
      type: 'generated',
      title: 'Albertosaurus English narration',
      tool: 'Qwen3-TTS CustomVoice',
      model: 'Qwen/Qwen3-TTS-12Hz-0.6B-CustomVoice',
      revision: '85e237c12c027371202489a0ec509ded67b5e4b5; Serena built-in voice; deterministic local generation',
      generatedOn: '2026-08-13',
      prompt: 'This is Albertosaurus, a prehistoric animal known as Albertosaurus sarcophagus. Look for its small brow crests. Watch the gentle breathing, head movement and tail motion that make this reconstruction feel alert.',
      sha256: 'd1eed8cc26d43b812ace4ed61b84723f503a2afc09bfb4f6d658f48e3d6ce68b',
      bytes: 144428,
    },
    license: {
      spdx: 'CC-BY-NC-SA-4.0',
