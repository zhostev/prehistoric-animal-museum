...
export const zhCN = {
  ...
  visibleFeature: '看看它醒目的“helmet crest”外形，再观察轻轻的呼吸、转头和尾部动作。',
  narration: {
    sentences: [
      '这是冠龙，学名是Corythosaurus casuarius。',
      '看看它醒目的“helmet crest”外形，再观察轻轻的呼吸、转头和尾部动作。',
    ],
    pronunciation: [{ text: '冠龙', reading: '冠龙' }],
  },
  facts: {
    period: '晚白垩世（约7700万至7500万年前）',
    discoveryRegions: ["加拿大阿尔伯塔省"],
    size: { kind: 'body-length', minMeters: 8.1, maxMeters: 9 },
    diet: 'herbivore',
  },
  parentClassificationNote: 'Corythosaurus casuarius在这里采用项目自制的风格化复原。轮廓突出“helmet crest”这一展示特征；体色和软组织属于审慎的展陈选择，并非化石直接保存的信息。',
  sources: [{
