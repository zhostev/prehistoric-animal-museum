...
export const provenance = [
  {
    ...
    source: {
      type: 'generated',
      title: 'Brachiosaurus deterministic procedural model source',
      ...
      sha256: 'df6990512e34bd3c982687a828bae06d5d648e1eac0a94560d827735af9a841e',
      bytes: 146220,
    },
    license: {
      spdx: 'CC0-1.0',
  ...
  },
  {
    ...
    source: {
      type: 'generated',
      title: 'Brachiosaurus habitat scene — landscape',
      tool: 'Blender 4.5.12 (project-authored habitat scene, deterministic seed)',
      generatedOn: '2026-08-17',
      prompt: 'Deterministic project-authored Blender habitat scene; scene spec qa/derivatives-scene-spec.json (SHA-256 abc9ce08f87009f75f543412391e1058cbd7d070e5c045f740ed07ce7b44537a) rendered with seed 1782577000 for the land habitat.',
      sha256: 'abc9ce08f87009f75f543412391e1058cbd7d070e5c045f740ed07ce7b44537a',
      bytes: 13350,
    },
    license: {
  ...
  },
  {
    ...
    source: {
      type: 'generated',
      title: 'Brachiosaurus habitat scene — portrait',
      tool: 'Blender 4.5.12 (project-authored habitat scene, deterministic seed)',
      generatedOn: '2026-08-17',
      prompt: 'Deterministic project-authored Blender habitat scene; scene spec qa/derivatives-scene-spec.json (SHA-256 abc9ce08f87009f75f543412391e1058cbd7d070e5c045f740ed07ce7b44537a) rendered with seed 1782577000 for the land habitat.',
      sha256: 'abc9ce08f87009f75f543412391e1058cbd7d070e5c045f740ed07ce7b44537a',
  ...
  },
  {
    ...
    source: {
      type: 'derived',
      title: 'Brachiosaurus transparent model still',
      generatedOn: '2026-08-17',
      inputAssetPaths: [
        'model/model.glb',
      ],
    ...
    runtime: {
      sha256: '4202a6ea39038285bae9e99a6a4ceaa24ab0e19d200de76520742d44f77b4348',
      bytes: 11556,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'derived',
      title: 'Brachiosaurus transparent portrait model still',
      generatedOn: '2026-08-17',
      inputAssetPaths: [
        'model/model.glb',
      ],
    ...
    runtime: {
      sha256: 'b50d3020b9582b3218b7097ae96087a1ec0f131c27d275bfe7cab27753a1f780',
      bytes: 3616,
    },
    modifications: [
      'Removed the habitat composite and all interface chrome; kept only the model and contact shadow on a transparent background.',
  ...
  },
  {
    ...
    source: {
      type: 'derived',
      title: 'Brachiosaurus collection thumbnail',
      generatedOn: '2026-08-17',
      inputAssetPaths: [
        'model/model.glb',
    ...
    runtime: {
      sha256: '80674747792ddfae7c1ebcae4181b9d4d4825b7dc0242cf30b0fb6360587705f',
      bytes: 2588,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'generated',
      title: 'Brachiosaurus Mandarin narration',
      ...
      generatedOn: '2026-08-17',
      prompt: '这是腕龙，学名是Brachiosaurus altithorax。看看它醒目的“high shoulders”外形，再观察轻轻的呼吸、转头和尾部动作。',
      sha256: '80b26a81fa852bfd87dfd54029c496dfc709e6cc8038a4a33412da46b49c6071',
      bytes: 110636,
    },
    license: {
      spdx: 'CC-BY-NC-SA-4.0',
  ...
  },
  {
    ...
    source: {
      type: 'generated',
      title: 'Brachiosaurus English narration',
      tool: 'Qwen3-TTS CustomVoice',
      model: 'Qwen/Qwen3-TTS-12Hz-0.6B-CustomVoice',
      revision: '85e237c12c027371202489a0ec509ded67b5e4b5; Serena built-in voice; deterministic local generation',
      generatedOn: '2026-08-17',
      prompt: 'This is Brachiosaurus, a prehistoric animal known as Brachiosaurus altithorax. Look for its high shoulders. Watch the gentle breathing, head movement and tail motion that make this reconstruction feel alert.',
      sha256: 'af5c54881b90746c8b00bd08c8b8a7677a0f30682311e240525af32929ada9f3',
      bytes: 138668,
    },
    license: {
      spdx: 'CC-BY-NC-SA-4.0',
