...
export const provenance = [
  {
    ...
    source: {
      type: 'generated',
      title: 'Diplodocus deterministic procedural model source',
      ...
      sha256: 'c5dbb02cab0ac2a3b5920afb6e7b11c5302bd7e523cb38566956be6ea4ff00dd',
      bytes: 145572,
    },
    license: {
      spdx: 'CC0-1.0',
    ...
    runtime: {
      sha256: '3afa9399c763515d7f8ad0252e9dbf2d26de4225977a9db991ba610e5ecfbfb5',
      bytes: 1351624,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'generated',
      title: 'Diplodocus habitat scene — landscape',
      tool: 'Blender 4.5.12 (project-authored habitat scene, deterministic seed)',
      generatedOn: '2026-08-17',
      prompt: 'Deterministic project-authored Blender habitat scene; scene spec qa/derivatives-scene-spec.json (SHA-256 a1184ca7a8e9c0a1c86479998d50a4af47170e13600272f4cfc523fa0c6f6282) rendered with seed 239664227 for the land habitat.',
      sha256: 'a1184ca7a8e9c0a1c86479998d50a4af47170e13600272f4cfc523fa0c6f6282',
      bytes: 13339,
    },
    license: {
    ...
    runtime: {
      sha256: '793056099f59176a00b7163ce24987577da428b24243f1c4f493c79df43c93e3',
      bytes: 15804,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'generated',
      title: 'Diplodocus habitat scene — portrait',
      tool: 'Blender 4.5.12 (project-authored habitat scene, deterministic seed)',
      generatedOn: '2026-08-17',
      prompt: 'Deterministic project-authored Blender habitat scene; scene spec qa/derivatives-scene-spec.json (SHA-256 a1184ca7a8e9c0a1c86479998d50a4af47170e13600272f4cfc523fa0c6f6282) rendered with seed 239664227 for the land habitat.',
      sha256: 'a1184ca7a8e9c0a1c86479998d50a4af47170e13600272f4cfc523fa0c6f6282',
    ...
    runtime: {
      sha256: '1055bae867843d55ce361c305e4ed3946a554b35944f939d8ad02cc4dadce68a',
      bytes: 10018,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'derived',
      title: 'Diplodocus transparent model still',
      generatedOn: '2026-08-17',
      inputAssetPaths: [
        'model/model.glb',
      ],
    ...
    runtime: {
      sha256: 'e48aa6bd8d9d616cc6620a4036bc0951fa0e4fd27bbe8c4a4cdd9573c7f77ec2',
      bytes: 11210,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'derived',
      title: 'Diplodocus transparent portrait model still',
      generatedOn: '2026-08-17',
      inputAssetPaths: [
        'model/model.glb',
      ],
    ...
    runtime: {
      sha256: '4a495c9a2ca351aef48c51e5d2121c1d3f0ab00c2957c21e5fefbafd06379b15',
      bytes: 3886,
    },
    modifications: [
      'Removed the habitat composite and all interface chrome; kept only the model and contact shadow on a transparent background.',
  ...
  },
  {
    ...
    source: {
      type: 'derived',
      title: 'Diplodocus collection thumbnail',
      generatedOn: '2026-08-17',
      inputAssetPaths: [
        'model/model.glb',
    ...
    runtime: {
      sha256: '6d88f1fd9f9e6c4ceb34a822488a2b3171a1691323dd4a9d9b55f9a2e629152b',
      bytes: 2576,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'generated',
      title: 'Diplodocus Mandarin narration',
      ...
      generatedOn: '2026-08-17',
      prompt: '这是梁龙，学名是Diplodocus carnegii。看看它醒目的“whip tail”外形，再观察轻轻的呼吸、转头和尾部动作。',
      sha256: '9055aaade7f7df4d6364967ff53e3cff8369defbfea694c230c60e1cd3fcf2c2',
      bytes: 96428,
    },
    license: {
      spdx: 'CC-BY-NC-SA-4.0',
  ...
  },
  {
    ...
    source: {
      type: 'generated',
      title: 'Diplodocus English narration',
      tool: 'Qwen3-TTS CustomVoice',
      model: 'Qwen/Qwen3-TTS-12Hz-0.6B-CustomVoice',
      revision: '85e237c12c027371202489a0ec509ded67b5e4b5; Serena built-in voice; deterministic local generation',
      generatedOn: '2026-08-17',
      prompt: 'This is Diplodocus, a prehistoric animal known as Diplodocus carnegii. Look for its whip tail. Watch the gentle breathing, head movement and tail motion that make this reconstruction feel alert.',
      sha256: '7a8b68f4effa74a669280a1c93ee8a6d48938c728dbdc9eecbc7c364eea84b80',
      bytes: 136748,
    },
    license: {
      spdx: 'CC-BY-NC-SA-4.0',
