...
export const provenance = [
  {
    ...
    source: {
      type: 'generated',
      title: 'Carcharodontosaurus deterministic procedural model source',
      ...
      sha256: 'e888757a2eb42de54052fe6f3722287cf5386e92e529878ac266f1961850fcbc',
      bytes: 101320,
    },
    license: {
      spdx: 'CC0-1.0',
    ...
    runtime: {
      sha256: '95d3a92481e95eb872c7b1c0c0f6640da0d177ef176d09582423a579cf0c92ff',
      bytes: 2022948,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'generated',
      title: 'Carcharodontosaurus habitat scene — landscape',
      tool: 'Blender 4.5.12 (project-authored habitat scene, deterministic seed)',
      generatedOn: '2026-08-17',
      prompt: 'Deterministic project-authored Blender habitat scene; scene spec qa/derivatives-scene-spec.json (SHA-256 78dd74cf4f4ca85e43f766f25ea974c9ac5f456f4ca8afbc18287c218267c584) rendered with seed 3995409601 for the land habitat.',
      sha256: '78dd74cf4f4ca85e43f766f25ea974c9ac5f456f4ca8afbc18287c218267c584',
      bytes: 13397,
    },
    license: {
    ...
    runtime: {
      sha256: 'c8984e50a69369b620b1782346919c7a7f6197c24917edca9e39ca349ae17c3b',
      bytes: 16006,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'generated',
      title: 'Carcharodontosaurus habitat scene — portrait',
      tool: 'Blender 4.5.12 (project-authored habitat scene, deterministic seed)',
      generatedOn: '2026-08-17',
      prompt: 'Deterministic project-authored Blender habitat scene; scene spec qa/derivatives-scene-spec.json (SHA-256 78dd74cf4f4ca85e43f766f25ea974c9ac5f456f4ca8afbc18287c218267c584) rendered with seed 3995409601 for the land habitat.',
      sha256: '78dd74cf4f4ca85e43f766f25ea974c9ac5f456f4ca8afbc18287c218267c584',
    ...
    runtime: {
      sha256: 'df31e71a98d8b2af904d4e709b8dc8793601096aaa10d61017b37f57019103e0',
      bytes: 9072,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'derived',
      title: 'Carcharodontosaurus transparent model still',
      generatedOn: '2026-08-17',
      inputAssetPaths: [
        'model/model.glb',
      ],
    ...
    runtime: {
      sha256: 'f9e5b9795e28dac7bf5ecc3e09d24ae12ed69cfffed03f05f69cc8c79aed309e',
      bytes: 11314,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'derived',
      title: 'Carcharodontosaurus transparent portrait model still',
      generatedOn: '2026-08-17',
      inputAssetPaths: [
        'model/model.glb',
      ],
    ...
    runtime: {
      sha256: '1dc23450477f5a2a884b110bcce6134a414b295f76e156d9203e244dd5bca9f2',
      bytes: 3310,
    },
    modifications: [
      'Removed the habitat composite and all interface chrome; kept only the model and contact shadow on a transparent background.',
  ...
  },
  {
    ...
    source: {
      type: 'derived',
      title: 'Carcharodontosaurus collection thumbnail',
      generatedOn: '2026-08-17',
      inputAssetPaths: [
        'model/model.glb',
    ...
    runtime: {
      sha256: '3757b2a48c7a767b38865d8320fa12df7d6704daa388cb37793fe65c616e7bf3',
      bytes: 2294,
    },
    modifications: [
  ...
  },
  {
    ...
    source: {
      type: 'generated',
      title: 'Carcharodontosaurus Mandarin narration',
      ...
      generatedOn: '2026-08-17',
      prompt: '这是鲨齿龙，学名是Carcharodontosaurus saharicus。看看它醒目的“deep skull”外形，再观察轻轻的呼吸、转头和尾部动作。',
      sha256: 'eab7296208442e69009909ddc9a9fc797181995aa8a8fb8e7282b17d1bbd898c',
      bytes: 125996,
    },
    license: {
      spdx: 'CC-BY-NC-SA-4.0',
  ...
  },
  {
    ...
    source: {
      type: 'generated',
      title: 'Carcharodontosaurus English narration',
      tool: 'Qwen3-TTS CustomVoice',
      model: 'Qwen/Qwen3-TTS-12Hz-0.6B-CustomVoice',
      revision: '85e237c12c027371202489a0ec509ded67b5e4b5; Serena built-in voice; deterministic local generation',
      generatedOn: '2026-08-17',
      prompt: 'This is Carcharodontosaurus, a prehistoric animal known as Carcharodontosaurus saharicus. Look for its deep skull. Watch the gentle breathing, head movement and tail motion that make this reconstruction feel alert.',
      sha256: '7f5a8be412f69c77380adfe2dad3aff00633931d059eb79937a27d53e769e8e6',
      bytes: 134252,
    },
    license: {
      spdx: 'CC-BY-NC-SA-4.0',
