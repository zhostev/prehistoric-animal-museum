...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('plateosaurus', 'model.glb'),
    modelBytes: 157884,
    poster: reviewAssetUrl('plateosaurus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('plateosaurus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('plateosaurus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('plateosaurus', 'background-landscape'),
      portrait: reviewAssetUrl('plateosaurus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    ...
    modelCredit: {
      attribution:
        '"Plateosaurus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Plateosaurus',
