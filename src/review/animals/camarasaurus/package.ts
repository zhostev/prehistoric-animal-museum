...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('camarasaurus', 'model.glb'),
    modelBytes: 214848,
    poster: reviewAssetUrl('camarasaurus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('camarasaurus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('camarasaurus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('camarasaurus', 'background-landscape'),
      portrait: reviewAssetUrl('camarasaurus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '圆顶龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Camarasaurus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Camarasaurus',
