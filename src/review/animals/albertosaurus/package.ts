...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('albertosaurus', 'model.glb'),
    modelBytes: 164812,
    poster: reviewAssetUrl('albertosaurus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('albertosaurus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('albertosaurus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('albertosaurus', 'background-landscape'),
      portrait: reviewAssetUrl('albertosaurus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'ready',
      sourcePath: 'audio/narration.zh-CN.mp3',
      mimeType: 'audio/mpeg',
      url: reviewAssetUrl('albertosaurus', 'narration.mp3'),
    },
    'en': {
      status: 'ready',
      sourcePath: 'audio/narration.en.mp3',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '阿尔伯塔龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Albertosaurus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Albertosaurus',
