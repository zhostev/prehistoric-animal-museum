...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('pachyrhinosaurus', 'model.glb'),
    modelBytes: 168548,
    poster: reviewAssetUrl('pachyrhinosaurus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('pachyrhinosaurus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('pachyrhinosaurus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('pachyrhinosaurus', 'background-landscape'),
      portrait: reviewAssetUrl('pachyrhinosaurus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '厚鼻龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Pachyrhinosaurus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Pachyrhinosaurus',
