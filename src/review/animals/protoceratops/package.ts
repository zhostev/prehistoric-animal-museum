...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('protoceratops', 'model.glb'),
    modelBytes: 171380,
    poster: reviewAssetUrl('protoceratops', 'poster.webp'),
    posterPortrait: reviewAssetUrl('protoceratops', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('protoceratops', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('protoceratops', 'background-landscape'),
      portrait: reviewAssetUrl('protoceratops', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '原角龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Protoceratops" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Protoceratops',
