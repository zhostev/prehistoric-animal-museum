...
export const zhCN = {
  ...
  visibleFeature: '看看它醒目的“back sail”外形，再观察轻轻的呼吸、转头和尾部动作。',
  narration: {
    sentences: [
      '这是异齿龙，学名是Dimetrodon grandis。',
      '看看它醒目的“back sail”外形，再观察轻轻的呼吸、转头和尾部动作。',
    ],
    pronunciation: [{ text: '异齿龙', reading: '异齿龙' }],
  },
  facts: {
    period: '早二叠世（约2.95亿至2.72亿年前）',
    discoveryRegions: ["美国"],
    size: { kind: 'body-length', minMeters: 3.15, maxMeters: 3.5 },
    diet: 'carnivore',
  },
  parentClassificationNote: 'Dimetrodon grandis在这里采用项目自制的风格化复原。轮廓突出“back sail”这一展示特征；体色和软组织属于审慎的展陈选择，并非化石直接保存的信息。',
  sources: [{
