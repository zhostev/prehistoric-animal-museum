...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('dimetrodon', 'model.glb'),
    modelBytes: 152204,
    poster: reviewAssetUrl('dimetrodon', 'poster.webp'),
    posterPortrait: reviewAssetUrl('dimetrodon', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('dimetrodon', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('dimetrodon', 'background-landscape'),
      portrait: reviewAssetUrl('dimetrodon', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'ready',
      sourcePath: 'audio/narration.zh-CN.mp3',
      mimeType: 'audio/mpeg',
      url: reviewAssetUrl('dimetrodon', 'narration.mp3'),
    },
    'en': {
      status: 'ready',
      sourcePath: 'audio/narration.en.mp3',
  ...
  review: {
    ...
    modelCredit: {
      attribution:
        '"Dimetrodon" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Dimetrodon',
