...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('oviraptor', 'model.glb'),
    modelBytes: 157976,
    poster: reviewAssetUrl('oviraptor', 'poster.webp'),
    posterPortrait: reviewAssetUrl('oviraptor', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('oviraptor', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('oviraptor', 'background-landscape'),
      portrait: reviewAssetUrl('oviraptor', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '窃蛋龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Oviraptor" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Oviraptor',
