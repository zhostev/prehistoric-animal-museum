...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('suchomimus', 'model.glb'),
    modelBytes: 171852,
    poster: reviewAssetUrl('suchomimus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('suchomimus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('suchomimus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('suchomimus', 'background-landscape'),
      portrait: reviewAssetUrl('suchomimus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '似鳄龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Suchomimus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Suchomimus',
