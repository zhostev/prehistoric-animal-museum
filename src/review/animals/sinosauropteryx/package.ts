...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('sinosauropteryx', 'model.glb'),
    modelBytes: 158024,
    poster: reviewAssetUrl('sinosauropteryx', 'poster.webp'),
    posterPortrait: reviewAssetUrl('sinosauropteryx', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('sinosauropteryx', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('sinosauropteryx', 'background-landscape'),
      portrait: reviewAssetUrl('sinosauropteryx', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '中华龙鸟完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Sinosauropteryx" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Sinosauropteryx',
