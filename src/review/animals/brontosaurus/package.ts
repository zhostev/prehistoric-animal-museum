...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('brontosaurus', 'model.glb'),
    modelBytes: 214964,
    poster: reviewAssetUrl('brontosaurus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('brontosaurus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('brontosaurus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('brontosaurus', 'background-landscape'),
      portrait: reviewAssetUrl('brontosaurus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    ...
    modelCredit: {
      attribution:
        '"Brontosaurus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Brontosaurus',
