...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('dimorphodon', 'model.glb'),
    modelBytes: 112244,
    poster: reviewAssetUrl('dimorphodon', 'poster.webp'),
    posterPortrait: reviewAssetUrl('dimorphodon', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('dimorphodon', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('dimorphodon', 'background-landscape'),
      portrait: reviewAssetUrl('dimorphodon', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '双型齿翼龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Dimorphodon" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Dimorphodon',
