...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('woolly-rhinoceros', 'model.glb'),
    modelBytes: 156408,
    poster: reviewAssetUrl('woolly-rhinoceros', 'poster.webp'),
    posterPortrait: reviewAssetUrl('woolly-rhinoceros', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('woolly-rhinoceros', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('woolly-rhinoceros', 'background-landscape'),
      portrait: reviewAssetUrl('woolly-rhinoceros', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '披毛犀完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Woolly rhinoceros" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Woolly rhinoceros',
