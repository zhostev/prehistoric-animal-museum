...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('deinonychus', 'model.glb'),
    modelBytes: 163980,
    poster: reviewAssetUrl('deinonychus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('deinonychus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('deinonychus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('deinonychus', 'background-landscape'),
      portrait: reviewAssetUrl('deinonychus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'ready',
      sourcePath: 'audio/narration.zh-CN.mp3',
      mimeType: 'audio/mpeg',
      url: reviewAssetUrl('deinonychus', 'narration.mp3'),
    },
    'en': {
      status: 'ready',
      sourcePath: 'audio/narration.en.mp3',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '恐爪龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Deinonychus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Deinonychus',
