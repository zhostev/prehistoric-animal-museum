...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('kronosaurus', 'model.glb'),
    modelBytes: 167880,
    poster: reviewAssetUrl('kronosaurus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('kronosaurus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('kronosaurus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('kronosaurus', 'background-landscape'),
      portrait: reviewAssetUrl('kronosaurus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '克柔龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Kronosaurus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Kronosaurus',
