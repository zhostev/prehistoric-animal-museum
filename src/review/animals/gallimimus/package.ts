...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('gallimimus', 'model.glb'),
    modelBytes: 157968,
    poster: reviewAssetUrl('gallimimus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('gallimimus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('gallimimus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('gallimimus', 'background-landscape'),
      portrait: reviewAssetUrl('gallimimus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '似鸡龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Gallimimus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Gallimimus',
