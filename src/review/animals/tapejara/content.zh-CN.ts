...
export const zhCN = {
  ...
  visibleFeature: '看看它醒目的“tall crest”外形，再观察轻轻的呼吸、转头和尾部动作。',
  narration: {
    sentences: [
      '这是古神翼龙，学名是Tapejara wellnhoferi。',
      '看看它醒目的“tall crest”外形，再观察轻轻的呼吸、转头和尾部动作。',
    ],
    pronunciation: [{ text: '古神翼龙', reading: '古神翼龙' }],
  },
  facts: {
  ...
  parentClassificationNote: 'Tapejara wellnhoferi在这里采用项目自制的风格化复原。轮廓突出“tall crest”这一展示特征；体色和软组织属于审慎的展陈选择，并非化石直接保存的信息。',
  sources: [{
