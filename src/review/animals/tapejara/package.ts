...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('tapejara', 'model.glb'),
    modelBytes: 118044,
    poster: reviewAssetUrl('tapejara', 'poster.webp'),
    posterPortrait: reviewAssetUrl('tapejara', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('tapejara', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('tapejara', 'background-landscape'),
      portrait: reviewAssetUrl('tapejara', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    ...
    modelCredit: {
      attribution:
        '"Tapejara" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Tapejara',
