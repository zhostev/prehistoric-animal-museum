...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('liopleurodon', 'model.glb'),
    modelBytes: 167852,
    poster: reviewAssetUrl('liopleurodon', 'poster.webp'),
    posterPortrait: reviewAssetUrl('liopleurodon', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('liopleurodon', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('liopleurodon', 'background-landscape'),
      portrait: reviewAssetUrl('liopleurodon', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '滑齿龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Liopleurodon" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Liopleurodon',
