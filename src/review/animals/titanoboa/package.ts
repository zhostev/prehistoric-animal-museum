...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('titanoboa', 'model.glb'),
    modelBytes: 125812,
    poster: reviewAssetUrl('titanoboa', 'poster.webp'),
    posterPortrait: reviewAssetUrl('titanoboa', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('titanoboa', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('titanoboa', 'background-landscape'),
      portrait: reviewAssetUrl('titanoboa', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '泰坦巨蟒完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Titanoboa" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Titanoboa',
