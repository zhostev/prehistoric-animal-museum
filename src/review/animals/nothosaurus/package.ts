...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('nothosaurus', 'model.glb'),
    modelBytes: 171832,
    poster: reviewAssetUrl('nothosaurus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('nothosaurus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('nothosaurus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('nothosaurus', 'background-landscape'),
      portrait: reviewAssetUrl('nothosaurus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    ...
    modelCredit: {
      attribution:
        '"Nothosaurus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Nothosaurus',
