...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('lambeosaurus', 'model.glb'),
    modelBytes: 152192,
    poster: reviewAssetUrl('lambeosaurus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('lambeosaurus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('lambeosaurus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('lambeosaurus', 'background-landscape'),
      portrait: reviewAssetUrl('lambeosaurus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '赖氏龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Lambeosaurus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Lambeosaurus',
