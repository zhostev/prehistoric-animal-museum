...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('styracosaurus', 'model.glb'),
    modelBytes: 185800,
    poster: reviewAssetUrl('styracosaurus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('styracosaurus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('styracosaurus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('styracosaurus', 'background-landscape'),
      portrait: reviewAssetUrl('styracosaurus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    ...
    modelCredit: {
      attribution:
        '"Styracosaurus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Styracosaurus',
