...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('shonisaurus', 'model.glb'),
    modelBytes: 167856,
    poster: reviewAssetUrl('shonisaurus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('shonisaurus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('shonisaurus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('shonisaurus', 'background-landscape'),
      portrait: reviewAssetUrl('shonisaurus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '秀尼鱼龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Shonisaurus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Shonisaurus',
