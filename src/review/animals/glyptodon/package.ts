...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('glyptodon', 'model.glb'),
    modelBytes: 173084,
    poster: reviewAssetUrl('glyptodon', 'poster.webp'),
    posterPortrait: reviewAssetUrl('glyptodon', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('glyptodon', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('glyptodon', 'background-landscape'),
      portrait: reviewAssetUrl('glyptodon', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'ready',
      sourcePath: 'audio/narration.zh-CN.mp3',
      mimeType: 'audio/mpeg',
      url: reviewAssetUrl('glyptodon', 'narration.mp3'),
    },
    'en': {
      status: 'ready',
      sourcePath: 'audio/narration.en.mp3',
  ...
  review: {
    ...
    modelCredit: {
      attribution:
        '"Glyptodon" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Glyptodon',
