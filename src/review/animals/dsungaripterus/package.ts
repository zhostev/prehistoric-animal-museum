...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('dsungaripterus', 'model.glb'),
    modelBytes: 112048,
    poster: reviewAssetUrl('dsungaripterus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('dsungaripterus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('dsungaripterus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('dsungaripterus', 'background-landscape'),
      portrait: reviewAssetUrl('dsungaripterus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '准噶尔翼龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Dsungaripterus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Dsungaripterus',
