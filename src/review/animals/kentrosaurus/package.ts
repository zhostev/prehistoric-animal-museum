...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('kentrosaurus', 'model.glb'),
    modelBytes: 172956,
    poster: reviewAssetUrl('kentrosaurus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('kentrosaurus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('kentrosaurus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('kentrosaurus', 'background-landscape'),
      portrait: reviewAssetUrl('kentrosaurus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '肯氏龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Kentrosaurus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Kentrosaurus',
