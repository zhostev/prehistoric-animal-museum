...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('iguanodon', 'model.glb'),
    modelBytes: 152116,
    poster: reviewAssetUrl('iguanodon', 'poster.webp'),
    posterPortrait: reviewAssetUrl('iguanodon', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('iguanodon', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('iguanodon', 'background-landscape'),
      portrait: reviewAssetUrl('iguanodon', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    ...
    modelCredit: {
      attribution:
        '"Iguanodon" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Iguanodon',
