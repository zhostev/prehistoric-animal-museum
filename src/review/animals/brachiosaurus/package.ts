...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('brachiosaurus', 'model.glb'),
    modelBytes: 222616,
    poster: reviewAssetUrl('brachiosaurus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('brachiosaurus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('brachiosaurus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('brachiosaurus', 'background-landscape'),
      portrait: reviewAssetUrl('brachiosaurus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'ready',
      sourcePath: 'audio/narration.zh-CN.mp3',
      mimeType: 'audio/mpeg',
      url: reviewAssetUrl('brachiosaurus', 'narration.mp3'),
    },
    'en': {
      status: 'ready',
      sourcePath: 'audio/narration.en.mp3',
  ...
  review: {
    ...
    modelCredit: {
      attribution:
        '"Brachiosaurus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Brachiosaurus',
