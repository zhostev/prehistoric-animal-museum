...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('opabinia', 'model.glb'),
    modelBytes: 203228,
    poster: reviewAssetUrl('opabinia', 'poster.webp'),
    posterPortrait: reviewAssetUrl('opabinia', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('opabinia', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('opabinia', 'background-landscape'),
      portrait: reviewAssetUrl('opabinia', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '欧巴宾海蝎完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Opabinia" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Opabinia',
