...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('psittacosaurus', 'model.glb'),
    modelBytes: 152152,
    poster: reviewAssetUrl('psittacosaurus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('psittacosaurus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('psittacosaurus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('psittacosaurus', 'background-landscape'),
      portrait: reviewAssetUrl('psittacosaurus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '鹦鹉嘴龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Psittacosaurus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Psittacosaurus',
