...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('paraceratherium', 'model.glb'),
    modelBytes: 152180,
    poster: reviewAssetUrl('paraceratherium', 'poster.webp'),
    posterPortrait: reviewAssetUrl('paraceratherium', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('paraceratherium', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('paraceratherium', 'background-landscape'),
      portrait: reviewAssetUrl('paraceratherium', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    ...
    modelCredit: {
      attribution:
        '"Paraceratherium" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Paraceratherium',
