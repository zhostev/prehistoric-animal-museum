...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('megatherium', 'model.glb'),
    modelBytes: 170640,
    poster: reviewAssetUrl('megatherium', 'poster.webp'),
    posterPortrait: reviewAssetUrl('megatherium', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('megatherium', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('megatherium', 'background-landscape'),
      portrait: reviewAssetUrl('megatherium', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '大地懒完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Megatherium" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Megatherium',
