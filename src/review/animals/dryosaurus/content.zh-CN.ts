...
export const zhCN = {
  ...
  visibleFeature: '看看它醒目的“runner legs”外形，再观察轻轻的呼吸、转头和尾部动作。',
  narration: {
    sentences: [
      '这是橡树龙，学名是Dryosaurus altus。',
      '看看它醒目的“runner legs”外形，再观察轻轻的呼吸、转头和尾部动作。',
    ],
    pronunciation: [{ text: '橡树龙', reading: '橡树龙' }],
  },
  facts: {
  ...
  parentClassificationNote: 'Dryosaurus altus在这里采用项目自制的风格化复原。轮廓突出“runner legs”这一展示特征；体色和软组织属于审慎的展陈选择，并非化石直接保存的信息。',
  sources: [{
