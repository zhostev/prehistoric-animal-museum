...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('dryosaurus', 'model.glb'),
    modelBytes: 152188,
    poster: reviewAssetUrl('dryosaurus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('dryosaurus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('dryosaurus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('dryosaurus', 'background-landscape'),
      portrait: reviewAssetUrl('dryosaurus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '橡树龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Dryosaurus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Dryosaurus',
