...
export const animal = {
  ...
  review: {
    badge: '自动 QA 通过',
    status: '菊石壳扫描完整本地草稿，等待科学、视觉、动作与听审',
    note:
      'Steph Piper (sjpiper145) 发布的 CC0-1.0 模型，源档案、许可证据、自包含 GLB、预算、八秒 Idle、landmarks 投影与五视口证据由自动化核对。 科学身份、解剖、材质、动作自然度、背景、文案、听审与公开分发决定全部仍是 human-only。',
    checks: [
