...
export const zhCN = {
  ...
  narration: {
    sentences: [
      '这是鲨齿龙，学名是Carcharodontosaurus saharicus。',
      '看看它醒目的“deep skull”外形，再观察轻轻的呼吸、转头和尾部动作。',
    ],
    pronunciation: [{ text: '鲨齿龙', reading: '鲨齿龙' }],
  },
  facts: {
    period: '晚白垩世（约1亿至9400万年前）',
    discoveryRegions: ["北非"],
    size: { kind: 'body-length', minMeters: 11.25, maxMeters: 12.5 },
    diet: 'carnivore',
  },
  parentClassificationNote: 'Carcharodontosaurus saharicus在这里采用项目自制的风格化复原。轮廓突出“deep skull”这一展示特征；体色和软组织属于审慎的展陈选择，并非化石直接保存的信息。',
  sources: [{
