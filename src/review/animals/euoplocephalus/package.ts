...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('euoplocephalus', 'model.glb'),
    modelBytes: 183168,
    poster: reviewAssetUrl('euoplocephalus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('euoplocephalus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('euoplocephalus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('euoplocephalus', 'background-landscape'),
      portrait: reviewAssetUrl('euoplocephalus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '包头龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Euoplocephalus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Euoplocephalus',
