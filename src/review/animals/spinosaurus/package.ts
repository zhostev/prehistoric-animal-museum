...
export const animal = {
  ...
  review: {
    badge: '已验收',
    status: '棘龙已完成人工验收，等待或已完成生产晋升',
    note:
      'Julian Johnson-Mortimer (@FreddyFoxFreddy) 发布的 CC-BY-4.0 模型，源档案、许可证据、自包含 GLB、预算、八秒 Idle、landmarks 投影与五视口证据均通过自动化核对；科学、解剖、材质、动作、背景、双语文案、双语听审、公开分发与生产决定已由产品负责人明确验收。',
    checks: [
    ...
    modelCredit: {
      attribution:
        '"Spinosaurus" by Julian Johnson-Mortimer (@FreddyFoxFreddy), Creative Commons Attribution 4.0 International. Normalized by the Prehistoric Animal Museum project for local review.',
