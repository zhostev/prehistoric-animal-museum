...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('monolophosaurus', 'model.glb'),
    modelBytes: 160872,
    poster: reviewAssetUrl('monolophosaurus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('monolophosaurus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('monolophosaurus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('monolophosaurus', 'background-landscape'),
      portrait: reviewAssetUrl('monolophosaurus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '单脊龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Monolophosaurus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Monolophosaurus',
