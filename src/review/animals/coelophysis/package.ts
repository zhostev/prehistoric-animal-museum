...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('coelophysis', 'model.glb'),
    modelBytes: 157988,
    poster: reviewAssetUrl('coelophysis', 'poster.webp'),
    posterPortrait: reviewAssetUrl('coelophysis', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('coelophysis', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('coelophysis', 'background-landscape'),
      portrait: reviewAssetUrl('coelophysis', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'ready',
      sourcePath: 'audio/narration.zh-CN.mp3',
      mimeType: 'audio/mpeg',
      url: reviewAssetUrl('coelophysis', 'narration.mp3'),
    },
    'en': {
      status: 'ready',
      sourcePath: 'audio/narration.en.mp3',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '腔骨龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Coelophysis" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Coelophysis',
