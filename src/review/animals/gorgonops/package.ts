...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('gorgonops', 'model.glb'),
    modelBytes: 159112,
    poster: reviewAssetUrl('gorgonops', 'poster.webp'),
    posterPortrait: reviewAssetUrl('gorgonops', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('gorgonops', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('gorgonops', 'background-landscape'),
      portrait: reviewAssetUrl('gorgonops', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '丽齿兽完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Gorgonops" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Gorgonops',
