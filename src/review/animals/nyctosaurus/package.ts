...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('nyctosaurus', 'model.glb'),
    modelBytes: 118112,
    poster: reviewAssetUrl('nyctosaurus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('nyctosaurus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('nyctosaurus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('nyctosaurus', 'background-landscape'),
      portrait: reviewAssetUrl('nyctosaurus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '夜翼龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Nyctosaurus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Nyctosaurus',
