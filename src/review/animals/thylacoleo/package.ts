...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('thylacoleo', 'model.glb'),
    modelBytes: 159220,
    poster: reviewAssetUrl('thylacoleo', 'poster.webp'),
    posterPortrait: reviewAssetUrl('thylacoleo', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('thylacoleo', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('thylacoleo', 'background-landscape'),
      portrait: reviewAssetUrl('thylacoleo', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    ...
    modelCredit: {
      attribution:
        '"Thylacoleo" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Thylacoleo',
