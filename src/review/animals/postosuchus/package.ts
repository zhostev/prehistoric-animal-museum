...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('postosuchus', 'model.glb'),
    modelBytes: 152124,
    poster: reviewAssetUrl('postosuchus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('postosuchus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('postosuchus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('postosuchus', 'background-landscape'),
      portrait: reviewAssetUrl('postosuchus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '波斯特鳄完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Postosuchus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Postosuchus',
