...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('diabloceratops', 'model.glb'),
    modelBytes: 185752,
    poster: reviewAssetUrl('diabloceratops', 'poster.webp'),
    posterPortrait: reviewAssetUrl('diabloceratops', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('diabloceratops', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('diabloceratops', 'background-landscape'),
      portrait: reviewAssetUrl('diabloceratops', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '恶魔角龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Diabloceratops" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Diabloceratops',
