...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('doedicurus', 'model.glb'),
    modelBytes: 183280,
    poster: reviewAssetUrl('doedicurus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('doedicurus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('doedicurus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('doedicurus', 'background-landscape'),
      portrait: reviewAssetUrl('doedicurus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '星尾兽完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Doedicurus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Doedicurus',
