...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('placodus', 'model.glb'),
    modelBytes: 168136,
    poster: reviewAssetUrl('placodus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('placodus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('placodus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('placodus', 'background-landscape'),
      portrait: reviewAssetUrl('placodus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '楯齿龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Placodus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Placodus',
