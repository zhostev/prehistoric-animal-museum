...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('hallucigenia', 'model.glb'),
    modelBytes: 169468,
    poster: reviewAssetUrl('hallucigenia', 'poster.webp'),
    posterPortrait: reviewAssetUrl('hallucigenia', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('hallucigenia', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('hallucigenia', 'background-landscape'),
      portrait: reviewAssetUrl('hallucigenia', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '怪诞虫完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Hallucigenia" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Hallucigenia',
