...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('compsognathus', 'model.glb'),
    modelBytes: 157872,
    poster: reviewAssetUrl('compsognathus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('compsognathus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('compsognathus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('compsognathus', 'background-landscape'),
      portrait: reviewAssetUrl('compsognathus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'ready',
      sourcePath: 'audio/narration.zh-CN.mp3',
      mimeType: 'audio/mpeg',
      url: reviewAssetUrl('compsognathus', 'narration.mp3'),
    },
    'en': {
      status: 'ready',
      sourcePath: 'audio/narration.en.mp3',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '美颌龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Compsognathus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Compsognathus',
