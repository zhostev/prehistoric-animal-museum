...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('inostrancevia', 'model.glb'),
    modelBytes: 159208,
    poster: reviewAssetUrl('inostrancevia', 'poster.webp'),
    posterPortrait: reviewAssetUrl('inostrancevia', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('inostrancevia', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('inostrancevia', 'background-landscape'),
      portrait: reviewAssetUrl('inostrancevia', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '伊诺史川兽完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Inostrancevia" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Inostrancevia',
