...
export const zhCN = {
  ...
  visibleFeature: '看看它醒目的“wide muzzle”外形，再观察轻轻的呼吸、转头和尾部动作。',
  narration: {
    sentences: [
      '这是尼日尔龙，学名是Nigersaurus taqueti。',
      '看看它醒目的“wide muzzle”外形，再观察轻轻的呼吸、转头和尾部动作。',
    ],
    pronunciation: [{ text: '尼日尔龙', reading: '尼日尔龙' }],
  },
  facts: {
    period: '早白垩世（约1.15亿至1.05亿年前）',
    discoveryRegions: ["尼日尔"],
    size: { kind: 'body-length', minMeters: 8.1, maxMeters: 9 },
    diet: 'herbivore',
  },
  parentClassificationNote: 'Nigersaurus taqueti在这里采用项目自制的风格化复原。轮廓突出“wide muzzle”这一展示特征；体色和软组织属于审慎的展陈选择，并非化石直接保存的信息。',
  sources: [{
