...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('nigersaurus', 'model.glb'),
    modelBytes: 214868,
    poster: reviewAssetUrl('nigersaurus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('nigersaurus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('nigersaurus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('nigersaurus', 'background-landscape'),
      portrait: reviewAssetUrl('nigersaurus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '尼日尔龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Nigersaurus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Nigersaurus',
