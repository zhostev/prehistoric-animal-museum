...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('desmatosuchus', 'model.glb'),
    modelBytes: 173028,
    poster: reviewAssetUrl('desmatosuchus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('desmatosuchus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('desmatosuchus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('desmatosuchus', 'background-landscape'),
      portrait: reviewAssetUrl('desmatosuchus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    ...
    modelCredit: {
      attribution:
        '"Desmatosuchus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Desmatosuchus',
