...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('ceratosaurus', 'model.glb'),
    modelBytes: 161960,
    poster: reviewAssetUrl('ceratosaurus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('ceratosaurus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('ceratosaurus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('ceratosaurus', 'background-landscape'),
      portrait: reviewAssetUrl('ceratosaurus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'ready',
      sourcePath: 'audio/narration.zh-CN.mp3',
      mimeType: 'audio/mpeg',
      url: reviewAssetUrl('ceratosaurus', 'narration.mp3'),
    },
    'en': {
      status: 'ready',
      sourcePath: 'audio/narration.en.mp3',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '角鼻龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Ceratosaurus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Ceratosaurus',
