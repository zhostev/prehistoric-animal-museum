...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('gomphotherium', 'model.glb'),
    modelBytes: 152148,
    poster: reviewAssetUrl('gomphotherium', 'poster.webp'),
    posterPortrait: reviewAssetUrl('gomphotherium', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('gomphotherium', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('gomphotherium', 'background-landscape'),
      portrait: reviewAssetUrl('gomphotherium', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '铲齿象完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Gomphotherium" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Gomphotherium',
