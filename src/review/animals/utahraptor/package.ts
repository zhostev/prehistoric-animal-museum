...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('utahraptor', 'model.glb'),
    modelBytes: 163908,
    poster: reviewAssetUrl('utahraptor', 'poster.webp'),
    posterPortrait: reviewAssetUrl('utahraptor', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('utahraptor', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('utahraptor', 'background-landscape'),
      portrait: reviewAssetUrl('utahraptor', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '犹他盗龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Utahraptor" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Utahraptor',
