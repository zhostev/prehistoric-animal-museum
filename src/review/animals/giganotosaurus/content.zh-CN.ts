...
export const zhCN = {
  ...
  narration: {
    sentences: [
      '这是南方巨兽龙，学名是Giganotosaurus carolinii。',
      '看看它醒目的“deep skull”外形，再观察轻轻的呼吸、转头和尾部动作。',
    ],
    pronunciation: [{ text: '南方巨兽龙', reading: '南方巨兽龙' }],
  },
  facts: {
    period: '晚白垩世（约9900万至9500万年前）',
    discoveryRegions: ["阿根廷巴塔哥尼亚"],
    size: { kind: 'body-length', minMeters: 11.7, maxMeters: 13 },
    diet: 'carnivore',
  },
  parentClassificationNote: 'Giganotosaurus carolinii在这里采用项目自制的风格化复原。轮廓突出“deep skull”这一展示特征；体色和软组织属于审慎的展陈选择，并非化石直接保存的信息。',
  sources: [{
