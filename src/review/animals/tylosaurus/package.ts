...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('tylosaurus', 'model.glb'),
    modelBytes: 167832,
    poster: reviewAssetUrl('tylosaurus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('tylosaurus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('tylosaurus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('tylosaurus', 'background-landscape'),
      portrait: reviewAssetUrl('tylosaurus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '海王龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Tylosaurus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
