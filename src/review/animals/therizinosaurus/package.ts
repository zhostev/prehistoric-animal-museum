...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('therizinosaurus', 'model.glb'),
    modelBytes: 170680,
    poster: reviewAssetUrl('therizinosaurus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('therizinosaurus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('therizinosaurus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('therizinosaurus', 'background-landscape'),
      portrait: reviewAssetUrl('therizinosaurus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '镰刀龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Therizinosaurus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Therizinosaurus',
