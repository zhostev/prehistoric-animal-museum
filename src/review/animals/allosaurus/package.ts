...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('allosaurus', 'model.glb'),
    modelBytes: 164812,
    poster: reviewAssetUrl('allosaurus', 'poster.webp'),
    posterPortrait: reviewAssetUrl('allosaurus', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('allosaurus', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('allosaurus', 'background-landscape'),
      portrait: reviewAssetUrl('allosaurus', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'ready',
      sourcePath: 'audio/narration.zh-CN.mp3',
      mimeType: 'audio/mpeg',
      url: reviewAssetUrl('allosaurus', 'narration.mp3'),
    },
    'en': {
      status: 'ready',
      sourcePath: 'audio/narration.en.mp3',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '异特龙完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Allosaurus" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Allosaurus',
