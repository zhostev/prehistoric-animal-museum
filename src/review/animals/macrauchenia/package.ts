...
export const animal = {
  ...
  provenance: [],
  assets: {
    model: reviewAssetUrl('macrauchenia', 'model.glb'),
    modelBytes: 152240,
    poster: reviewAssetUrl('macrauchenia', 'poster.webp'),
    posterPortrait: reviewAssetUrl('macrauchenia', 'poster-portrait.webp'),
    thumbnail: reviewAssetUrl('macrauchenia', 'thumbnail.webp'),
    backgrounds: {
      landscape: reviewAssetUrl('macrauchenia', 'background-landscape'),
      portrait: reviewAssetUrl('macrauchenia', 'background-portrait'),
    },
    narration: {
    'zh-CN': {
      status: 'pending-review',
  ...
  review: {
    badge: '自动 QA 通过',
    status: '后弓兽完整本地草稿，等待科学、视觉、动作与听审',
    note:
    ...
    modelCredit: {
      attribution:
        '"Macrauchenia" by Prehistoric Animal Museum (project-authored), CC0 1.0 Universal Public Domain Dedication. Normalized by the Prehistoric Animal Museum project for local review.',
      licenseName: 'CC0 1.0 Universal Public Domain Dedication',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
      sourceTitle: 'Macrauchenia',
